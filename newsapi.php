<?php
$apikeynews = "3fd92e403059402480b15b96fb08cb88";//TA Client
function curl_post($url,$uid,$password){
	...
	curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-type: application/json', "X-API-KEY: $apikeynews"));
...
$status = curl_get("https://newsapi.org/v2/top-headlines?country=id&apiKey=3fd92e403059402480b15b96fb08cb88");

$arberita['berita'] = json_decode($status);
// print_r($arrMhs);
// foreach($arrMhs as $idx => $mhs){
// 	echo $idx." ".$mhs['nama']."</br>";
// }
file_put_contents("testing.txt",json_encode($arberita));
//echo $status = curl_get("https://simak.poliupg.ac.id/api/machine/get_tabel_konten/bri_mhs_aktif/thn_ajar/20191/kode_prodi/kelas/");
